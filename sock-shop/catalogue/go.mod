module github.com/usmanager/manager/microservices/sock-shop/catalogue
...
require (
	...
	github.com/influxdata/influxdb v1.1.1-0.20161209155552-855c567c67d7 // indirect
	...
	gopkg.in/DATA-DOG/go-sqlmock.v1 v1.1.4 // indirect
